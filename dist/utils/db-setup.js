...
var meal_model_1 = __importDefault(require("../models/meal-model"));
var daily_assessment_model_1 = __importDefault(require("../models/daily-assessment-model"));
var daily_plan_model_1 = __importDefault(require("../models/daily-plan-model"));
var monthly_plan_model_1 = __importDefault(require("../models/monthly-plan-model"));
var monthly_assessment_model_1 = __importDefault(require("../models/monthly-assessment-model"));
var weekly_plan_model_1 = __importDefault(require("../models/weekly-plan-model"));
var weekly_assessment_model_1 = __importDefault(require("../models/weekly-assessment-model"));
function createDatabaseAssociations() {
